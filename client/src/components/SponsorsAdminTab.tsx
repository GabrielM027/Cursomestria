...
export function SponsorsAdminTab({ data }: { data: any }) {
  ...
  const clearForm = () => {
    setEditingId(""); setName(""); setIsActive(true); setDisplayScale("100"); setOffsetX("0"); setOffsetY("0"); setFitMode("cover"); setSortOrder(String((data.sponsors?.length || 0) * 10)); setFile(null);
  };
  useEffect(() => {
